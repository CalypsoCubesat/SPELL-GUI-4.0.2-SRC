...
set ECLIPSE_BASE=R:\NewSpellDev\build\eclipse-SDK-4.8M5-linux-gtk
set BUILD_BASE_DIR=%~DP0..\SPELL-GUI_build_linux
set JAVA=D:\Programs\Java\jdk1.8.0_25\bin\java
set SPELL_GUI_COTS=R:\NewSpellDev\build\eclipse-SDK-4.8M5-linux-gtk
...
copy "%SPELL_GUI_REPO%\linux_build.properties" "%BUILD_BASE_DIR%\build.properties"
