/* Generated By:JJTree&JavaCC: Do not edit this line. SpellGrammar30.java */
package com.astra.ses.spell.language.grammar30;

import java.util.List;

import com.astra.ses.spell.language.ParseException;
import com.astra.ses.spell.language.common.AbstractJJTPythonGrammarState;
import com.astra.ses.spell.language.common.AbstractPythonGrammar;
import com.astra.ses.spell.language.common.EmptySuiteException;
...
public final class SpellGrammar30 extends AbstractPythonGrammar implements /*@bgen(jjtree)*/IGrammar,
        SpellGrammar30Constants {/*@bgen(jjtree)*/
    ...
    public SpellGrammar30TokenManager token_source;
    /** Current token. */
    public Token token;
    /** Next token. */
    public Token jj_nt;
    ...
    public SpellGrammar30(boolean generateTree, FastCharStream stream) {
        super(generateTree);
        builder = jjtree.builder;
        token_source = new SpellGrammar30TokenManager(stream);
        token = new Token();
        jj_ntk = -1;
        jj_gen = 0;
        for (int i = 0; i < 148; i++)
    ...
    public SpellGrammar30(boolean generateTree, SpellGrammar30TokenManager tm) {
        super(generateTree);
        builder = jjtree.builder;
        token_source = tm;
        token = new Token();
