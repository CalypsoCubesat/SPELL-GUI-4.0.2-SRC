/* Generated By:JJTree&JavaCC: Do not edit this line. SpellGrammar27TokenManager.java */
...
public final class SpellGrammar27TokenManager extends AbstractTokenManager implements SpellGrammar27Constants {
    public boolean usePrintAsFunction = false;

    protected Class<?> getConstantsClass() {
        return SpellGrammar27Constants.class;
    }
    ...
    /** Constructor. */
    public SpellGrammar27TokenManager(FastCharStream stream) {
        input_stream = stream;
    }

    /** Constructor. */
    public SpellGrammar27TokenManager(FastCharStream stream, int lexState) {
        this(stream);
        SwitchTo(lexState);
    }
