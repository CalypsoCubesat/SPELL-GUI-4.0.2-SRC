/* Generated By:JJTree&JavaCC: Do not edit this line. SpellGrammar27.java */
...
public final class SpellGrammar27 extends AbstractPythonGrammar implements /*@bgen(jjtree)*/IGrammar,
        SpellGrammar27Constants {/*@bgen(jjtree)*/
    ...
    public SpellGrammar27TokenManager token_source;
    /** Current token. */
    public Token token;
    /** Next token. */
    public Token jj_nt;
    ...
    public SpellGrammar27(boolean generateTree, FastCharStream stream) {
        super(generateTree);
        builder = jjtree.builder;
        token_source = new SpellGrammar27TokenManager(stream);
        token = new Token();
        jj_ntk = -1;
        jj_gen = 0;
        for (int i = 0; i < 139; i++)
    ...
    public SpellGrammar27(boolean generateTree, SpellGrammar27TokenManager tm) {
        super(generateTree);
        builder = jjtree.builder;
        token_source = tm;
        token = new Token();
