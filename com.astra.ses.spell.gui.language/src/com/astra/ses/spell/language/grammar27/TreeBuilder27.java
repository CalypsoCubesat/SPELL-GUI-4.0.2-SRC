package com.astra.ses.spell.language.grammar27;
...
import com.astra.ses.spell.language.common.JJTPythonGrammarState;
...
import com.astra.ses.spell.language.model.ast.Print;
import com.astra.ses.spell.language.model.ast.Raise;
import com.astra.ses.spell.language.model.ast.Repr;
...
public final class TreeBuilder27 extends AbstractTreeBuilder implements ITreeBuilder, ITreeConstants {
    ...
    public final SimpleNode onCloseNode(SimpleNode n, int arity) throws Exception {
        ...
        switch (n.getId()) {
            ...
            default:
                System.err.println(("Error at TreeBuilder: default not treated:" + n.getId()));
                return null;
        }
    }
